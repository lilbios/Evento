...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Evento.Models.Entities.Snapshoot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("MemorizeId")
                        .HasColumnType("int");

                    b.Property<byte[]>("SnapshootPhoto")
                        .HasColumnType("varbinary(max)");

                    b.HasKey("Id");

                    b.HasIndex("MemorizeId");
            ...
            modelBuilder.Entity("Evento.Models.Entities.Snapshoot", b =>
                {
                    b.HasOne("Evento.Models.Entities.Memorize", "Memorize")
                        .WithMany("Snapshoots")
                        .HasForeignKey("MemorizeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
